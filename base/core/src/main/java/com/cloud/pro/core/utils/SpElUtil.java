...
public class SpElUtil {
     ...
     */
    @Data
    private static class ExpressionEvaluator extends CachedExpressionEvaluator {
        ...
        private EvaluationContext createEvaluationContext(String className,
            ...
            ExpressionRootObject root = new ExpressionRootObject(className, methodName, classType, method, args, parameterTypes, target);
