...
-- ----------------------------
-- Table structure for cloud_pro_file
-- ----------------------------
DROP TABLE IF EXISTS `cloud_pro_file`;

CREATE TABLE `cloud_pro_file`
(
...
-- ----------------------------
-- Table structure for cloud_pro_share
-- ----------------------------
DROP TABLE IF EXISTS `cloud_pro_share`;
CREATE TABLE `cloud_pro_share`
(
    ...
    `share_end_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '分享结束时间',
...
-- ----------------------------
-- Table structure for cloud_pro_share_file
-- ----------------------------
DROP TABLE IF EXISTS `cloud_pro_share_file`;
CREATE TABLE `cloud_pro_share_file`
(
...
-- ----------------------------
-- Table structure for cloud_pro_user
-- ----------------------------
DROP TABLE IF EXISTS `cloud_pro_user`;
CREATE TABLE `cloud_pro_user`
(
...
-- ----------------------------
-- Table structure for cloud_pro_user_file
-- ----------------------------
DROP TABLE IF EXISTS `cloud_pro_user_file`;
CREATE TABLE `cloud_pro_user_file`
(
...
-- ----------------------------
-- Table structure for cloud_pro_user_search_history
-- ----------------------------
DROP TABLE IF EXISTS `cloud_pro_user_search_history`;
CREATE TABLE `cloud_pro_user_search_history`
(
    `id`             bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
    `user_id`        bigint(0) NOT NULL COMMENT '用户id',
...
-- ----------------------------
-- Table structure for cloud_pro_file_chunk
-- ----------------------------

DROP TABLE IF EXISTS `cloud_pro_file_chunk`;
CREATE TABLE `cloud_pro_file_chunk`
(
...
-- ----------------------------
-- Table structure for cloud_pro_error_log
-- ----------------------------

DROP TABLE IF EXISTS `cloud_pro_error_log`;
CREATE TABLE `cloud_pro_error_log`
(
    `id`          bigint                           NOT NULL AUTO_INCREMENT COMMENT '主键',
